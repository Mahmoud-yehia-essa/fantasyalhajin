...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            <h4 class="mb-4">تحديد المستخدم ورشح اي مطية</h4>

            <form action="{{ route('store.nomination.user') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    <button type="submit" class="btn btn-success">إضافة مستخدم لترشيح مطيه</button>
                </div>
            </form>
        </div>
    </div>
