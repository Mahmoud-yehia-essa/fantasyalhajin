...
return new class extends Migration
{
    ...
    {
        Schema::create('festival_point_users', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('festival_point_id')->constrained('festival_points')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('festival_point_users');
    }
};
